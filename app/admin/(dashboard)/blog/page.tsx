    ...
    <div>
      ...
      <ResponsiveTable
        ...
        columns={[
          ...
          { header: "Date", cell: (post) => post.publishedAt ?? (post.scheduledFor ? `Scheduled: ${post.scheduledFor}` : "-") },
        ...
        renderMobileCard={(post) => (
          <>
            ...
            <div className="mt-3 space-y-1 border-t border-secondary/10 pt-3">
              ...
              <MobileCardField label="Date" value={post.publishedAt ?? (post.scheduledFor ? `Scheduled: ${post.scheduledFor}` : "-")} />
            </div>
          </>
        )}
      />

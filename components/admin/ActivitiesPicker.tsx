  ...
  return (
    <section className="card p-6">
      ...
      <p className="mt-1 text-xs text-foreground/50">
        Reusable named activities included in this product (e.g. "Maasai Mara Game Drive"). Add new ones in{" "}
      ...
      {activities.length === 0 ? (
        <p className="mt-3 text-sm text-foreground/50">No activities in the library yet.</p>
      ) : (
